    ...
    <div class="center">
        <div class="loan-in-phone__box">
            ...
            <div class="loan-in-phone__content">
                ...
                <form action="/ajax/form-phone.php" class="loan-in-phone__form form form--validate form--ajax form--callback" novalidate="novalidate">
                    <div class="loan-in-phone__form-input input-box">
